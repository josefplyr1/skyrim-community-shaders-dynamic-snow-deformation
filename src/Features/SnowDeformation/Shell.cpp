...
void SnowDeformation::DrawShell()
{
	...
	cbData.ShellDebugData = shellDataDebug ? 1u : (shellExclusionDebug ? 2u : (shellBorderDebug ? 3u : (shellSSSDebug ? 4u : 0u)));
	...
	// x compaction matte; yzw spare (Stage 1 darken/roughen and Stage 2
	// combing both retired).
